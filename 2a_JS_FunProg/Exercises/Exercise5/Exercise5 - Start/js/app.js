/*
The purpose of this exercise is to rewrite our RMF functions below using
...
//function(val) { return (val < 10) ? val * 10 : val;}
...
//Note the notation here, our initilization value is placed after the function,
//Delimited with a comma.
//Provide a count for the number of scores still remaining.
const scoresCnt = rmvZeroScores.reduce(cnt => cnt + 1,0);
